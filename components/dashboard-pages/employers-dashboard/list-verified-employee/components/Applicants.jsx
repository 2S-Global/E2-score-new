...
const Applicants = () => {
  ...
  {[
    ...
    {
      label: "Voter",
      response: candidate.voter_response,
    },
    {
      label: "License",
      response: candidate.license_response,
    },
    {
      label: "Passport",
    ...
    return (
      <li key={index} className="list-group-item d-flex justify-content-between align-items-center p-1 small">
