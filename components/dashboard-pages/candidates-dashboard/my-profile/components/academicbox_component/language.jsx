...
const LanguageProficiency = () => {
  ...
  return (
    <div>
<label className="form-label" style={{ fontWeight: 600, fontSize: "20px" }}>
  Language proficiency
</label>

      <p className="text-muted" style={{ fontSize: "14px" }}>Strengthen your resume by letting recruiters know you can communicate in multiple languages</p>
      ...
      {languages.map((lang, index) => (
        <div key={index} style={{ marginBottom: '20px', borderBottom: '1px solid #ccc', paddingBottom: '10px' }}>
          <div style={{ display: 'flex', gap: '10px', marginBottom: '10px' }}>
            ...
            <div style={{ flex: 1 }}>
                 <label className="form-label"><b>Proficiency</b></label>
              <select
          ...
          <div style={{ display: 'flex', gap: '15px', marginBottom: '10px' }}>
            ...
            <button
              ...
              style={{ color: 'blue', background: 'none', border: 'none', cursor: 'pointer', marginLeft: 'auto' }}
            >
              Delete
            </button>
          </div>
