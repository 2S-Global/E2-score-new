...
const PersonalModal = ({ show, onClose ,focusSection   }) => {
  ...
  const [selectedMaritalStatus, setSelectedMaritalStatus] = useState("Single/unmarried");
  ...
  useEffect(() => {
    if (show && focusSection) {
      ...
      sections[focusSection]?.current?.scrollIntoView({ behavior: "smooth", block: "center" });
    }
  }, [show, focusSection]);
        ...
        <div className="modal-dialog modal-dialog-centered">
          <div className="modal-content p-3">
            ...
            <div className="modal-body">
              <p className="text-muted">This information helps employers know you better.</p>
              ...
              <form>
                ...
                <div className="mb-3">
                <label className="form-label"><b>More information</b></label>
                  <p className="text-muted" style={{ fontSize: "14px" }}>
                    Companies are focusing on equal opportunities and might be looking for candidates from diverse backgrounds.
                  </p>
                  <div className="d-flex gap-2 flex-wrap">
                    {["Single parent +", "Working mother +", "Served in military +", "Retired (60+) +", "LGBTQ+ +"].map((info) => (
                      <button
                        key={info}
...
<label className="form-label"><b>Category</b></label>
  ...
  <div className="d-flex gap-2 flex-wrap">
    {["General", "Scheduled Caste (SC)", "Scheduled Tribe (ST)", "OBC - Creamy", "OBC - Non creamy", "Other"].map((category) => (
      <button
        key={category}
        onClick={(e) => {
          e.preventDefault();
...
<div className="mb-3">
<label className="form-label"><b>Are you differently abled?</b></label>
...
<label className="form-label"><b>Have you taken a career break?</b></label>
  <div className="d-flex gap-3">
    {["Yes", "No"].map((option) => (
      <label key={option} className="form-check-label">
        <input
...
<div className="mb-3" ref={workPermit}>      
    <label className="form-label"><b>Work permit for USA</b></label>
    <div className="d-flex gap-3">
        ...
        <select className="form-select">
            ...
            {["Have US H1 Visa", "Need US H1 Visa", "US TN Permit Holder","US Green Card Holder", "US Citizen" ,"Authorized to work in US"].map((option) => (
...
<div className="mb-3">
      <label className="form-label"><b>Work permit for other countries (Max 3)</b></label>
      <Select
        isMulti
        options={locations}
...
{/* Permanent address */}
    <div className = "mb-3">
        <label className="form-label"><b>Permanent address</b></label>
        <input type="text" className="form-control" placeholder="Enter Your Permanent address" />
    </div>
    {/* Hometown */}
    <div className = "mb-3">
        <label className="form-label"><b>Hometown</b></label>
