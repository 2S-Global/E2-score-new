      ...
      <div className="modal-dialog modal-dialog-centered">
        <div className="modal-content">
          ...
          <div className="modal-body">
            ...
            <div className="mb-3">
                <label className="form-label"><b>Certification completion ID</b></label>
                <input type="text" className="form-control" placeholder="Enter Certification completion ID" />
            </div>
            {/* URL */}
            <div className="mb-3">
                <label className="form-label"><b>Certification URL</b></label>
                <input type="text" className="form-control" placeholder="Enter Certification URL here" />
            </div>

             {/* Duration From */}
             <div className="mb-3 row">
             <label className="form-label"><b>Certification validity From</b></label>
            ...
            {months.map((month, index) => (
              <option key={index} value={month}>{month}</option>
                 ...
                 {/* Duration To */}
                 <div className="mb-3 row">
             <label className="form-label"><b>Certification validity To</b></label>
                <div className="col-md-6">
                <select className="form-select" value={fromYear} onChange={(e) => setFromYear(e.target.value)}>
            <option value="">Select year</option>
            {years.map((year) => (
        ...
        <input
          ...
          id="currentWork"
        />
        <label htmlFor="currentWork">This certification does not expire</label>
      </div>
        </div>
          </div>
