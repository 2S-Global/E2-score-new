      ...
      <div className="modal-dialog modal-dialog-centered">
        <div className="modal-content">
          ...
          <div className="modal-header">
            <h5 className="modal-title">White paper / Research publication / Journal entry</h5>
          ...
          <div className="modal-body">
            <p style={{ color: 'black' }}>
            Add links to your online publications </p>
            ...
            <div className="mb-3">
             ...
             <label className="form-label"><b>Published on</b></label>
