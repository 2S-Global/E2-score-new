...
const EmploymentModal = ({ show, onClose }) => {
  ...
  const handleGenerateHeadline = () => {
    if (isGenerated) {
      ...
      setDescription("Experienced Software Developer with expertise in designing, developing, and deploying scalable web applications. Proficient in React.js, Node.js, and modern backend technologies. Skilled in API development, system architecture, and database management. Adept at problem-solving, collaborating with cross-functional teams, and optimizing application performance for a seamless user experience.");
  ...
  const suggestedSkills = ["Startup", "Web Designing", "Mobile Development", "Computer Science"];
      ...
      <div className="modal-dialog modal-dialog-centered">
        <div className="modal-content">
          ...
          <div className="modal-body">
            <p style={{ color: 'black' }}>Details like job title, company name, etc, help employers understand your work</p>
            ...
            <div className="mb-3">
              {skills.map((skill, index) => (
                <span key={index} className="badge bg-secondary me-2 p-2">
                  {skill}{" "}
                  <button className="btn btn-sm btn-light ms-2" onClick={() => handleRemoveSkill(skill)}>
                    ×
                  </button>
                </span>
              ))}
          ...
          <div className="modal-footer">
            ...
            <button className="btn btn-primary" onClick={handleSave} disabled={skills.length === 0}>Save</button>
          </div>
        </div>
      </div>
    </div>
