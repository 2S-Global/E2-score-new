      ...
      <div className="modal-dialog modal-dialog-centered">
        <div className="modal-content">
          ...
          <div className="modal-body">
            <p style={{ color: 'black' }}>Add skills that define your expertise (Minimum 1)</p>
            ...
            <div className="input-group mb-3">
              <input
                ...
                onChange={(e) => {
                  ...
                  if (allskills.includes(selectedSkill) && !skills.includes(selectedSkill)) {
            ...
            {/* Suggested Skills */}
            <div className="mt-3">
              <p style={{ color: 'black' }}>Or select from suggested skills:</p>
              {suggestedSkills.map((skill, index) => (
                <button key={index} className="btn btn-outline-secondary m-1" onClick={() => handleSelectSuggested(skill)}>
                  {skill}
                </button>
              ))}
            </div>
