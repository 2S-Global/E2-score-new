...
import { colleges, courses, diploma_st_uni, savedAcademicData , university  } from "./academicbox_component/academicData";
  ...
  return (
    <>
      ...
      <form className="default-form">
              ...
              <div className="row">
                ...
                <div className="form-group col-lg-4">
                  ...
                  <input
                    ...
                    onChange={(e) => handleChange(item.id, "totalMarks", e.target.value)}
                  />
                </div>
                ...
                <div className="form-group col-lg-4">
                  ...
                  <input
                    ...
                    onChange={(e) => handleChange(item.id, "marksObtain", e.target.value)}
                  />
                </div>
        ...
        <SearchableInput label="Institute name" value={collegeSearch} onChange={handleCollegeSearch} options={filteredColleges} onSelect={handleCollegeSelect} />
...
<div className="form-group col-lg-4">
  ...
  />
            ...
            <button type="button" className="btn btn-success mt-2 ml-2" onClick={() => handleSubmit(item.id)}>
              Submit
            </button>
          </div>
        ))}
